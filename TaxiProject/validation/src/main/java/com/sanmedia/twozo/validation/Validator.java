package com.sanmedia.twozo.validation;
...
public class Validator {
     ...
     *
     * @param registration registration of the com.TaxiProject.driver
     * @return registration of the com.TaxiProject.driver
     */
     ...
     *
     * @param pinCode pin code of the user/com.TaxiProject.driver
     * @return registration of the user/com.TaxiProject.driver
     */
