...
import com.sanmedia.twozo.user.controller.DriverController;
import com.sanmedia.twozo.user.model.Driver;
import com.sanmedia.twozo.user.model.User;
import com.sanmedia.twozo.validation.Validator;
...
public class DriverPage {
    ...
    /**
     * Enables com.TaxiProject.driver to choose their choice of {@link Service} being retrieved from the database.
     * 
    ...
    /**
     * Updates com.TaxiProject.driver's info based on ID number passed
     *
     * @return whether removed successfully
     */
